class Resume < ApplicationRecord
  ...
  validates :first_name_kana, presence: true, kana: true, allow_blank: true
  validates :last_name,       presence: true
  validates :last_name_kana,  presence: true, kana: true, allow_blank: true
  ...
  def require_career_over_one_month
    errors.add(:base, :no_cardgame) if card_game_experiences.length == 0
